...
const DoctorListForCounselor = (props)=> {
    ...
    return (
        <div className = "doctor-list-container">
            ...
            {
                (doctorsList !=null) ? doctorsList.map(item=> (<PatientCounselorCard image = {item.profileImage.image} designation={item.role[0].role} name = {item.name} qualification = "PHD| MBBS |Other degree" id = {item.email} card_type = ""/>)): <></>
            }
...
export default DoctorListForCounselor;